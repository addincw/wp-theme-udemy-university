...
<div class="full-width-split group">
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
            $qBlogs = new WP_Query(['posts_per_page' => 2]); //get latest 2 post data
            ...
            <p class="t-center no-margin">
                <a href="<?php echo site_url('/blogs') ?>" class="btn btn--yellow">View All Blog Posts</a>
            </p>
        </div>
    </div>
</div>
            ...
            <div class="hero-slider__slide" style="background-image: url(<?php echo get_theme_file_uri('assets/images/bread.jpg'); ?>)">
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
                        ...
                        <p class="t-center">Udemy University offers lunch plans for those in need.</p>
                        <p class="t-center no-margin"><a href="#" class="btn btn--blue">Learn more</a></p>
                    </div>
                </div>
            </div>
